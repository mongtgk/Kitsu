...
- HTTP-клиент (axios) настроен на timeout 10 секунд; автоматических ретраёв нет. Повторы допускаются только вручную или явно запрограммированным одиночным повтором.
